...
\newacronym{cnn}{CNN}{Coupled-Nearest-Neighbor}
\newacronym{va}{r.v.}{random variable}
\newacronym{iid}{i.i.d.}{independent and identically distributed}
\newacronym{pdf}{density}{probability density function}
\newacronym{pmf}{pmf}{probability mass function}
\newacronym{kde}{KDE}{Kernel Density Estimation}
\newacronym{pde}{PDE}{Probability of Detecting an Earthquake}
\newacronym{tcef}{TCEF}{temporal course of earthquake frequency}
...
\newacronym{iag}{IAG}{Institute of Astronomy, Geophysics and Atmospherical Sciences}
...
\newacronym{relm}{RELM}{Regional Earthquake Likelihood Models}
\newacronym{ed}{ED}{error diagram}

\newacronym{mmi}{MMI}{Modified Mercalli Intensity scale}
