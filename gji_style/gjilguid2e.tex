...
\title[Smoothing seismicity applied to Brazilian PSHA]
  {Smoothing seismicity applied to Brazilian PSHA}
\author[M. Pirchiner]
  {Marlon Pirchiner$^{1,2}$\thanks{Marcelo Assump\c{c}\~ao, Vincent Guigues and Stephane Drouet} \\
  $^1$ Institute of Astronomy, Geophysics and Atmospherical Sciences (IAG), University of S\~ao Paulo (USP) \\
  $^2$ Applied Math School (EMAp), Get\'ulio Vargas Foundation (FGV), Rio de Janeiro.}
\date{original form January, 2015}
